...
var signupController = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, firstName, lastName, password, existingUser, hash, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                hash = _b.sent();
                newUser = new user_model_1.default({ email: email, firstName: firstName, lastName: lastName, password: hash });
